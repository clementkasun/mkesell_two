                        ...
                        <div class="row bg-light">
                            <div class="col-md-12">
                                <div class="text-center">
                                    ...
                                    <img class="profile-user-img circle-img img-fluid img-circle" src="{{asset('/storage/'.$post_data->main_image')}}" alt="post main picture" style="width:10em; height:10em; max-width: 100%; max-height: 100%;" />
                                    @endif
