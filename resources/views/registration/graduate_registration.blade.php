            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Registration form for graduates and skill workers</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <div class="card-body">
                        <form id='graduate_registration' name="graduate_registration">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div><input type="text" class="form-control" name="tel" id="Telephone" minlength="10" maxlength="10" placeholder="07x-xxxxxxx" required></div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" value="male" name="gender" checked="true" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div><input type="text" class="form-control" name="nic" id="nic" minlength="10" maxlength="12" placeholder="NIC" required></div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" value="single" type="radio" name="civil_status" checked="true" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="university">University / Institute &nbsp;&nbsp;&nbsp;&nbsp;(විශ්වවිද්‍යාලය / ආයතනය)</label>
                                        <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" name="year" id="degree_year" placeholder="Degree year" maxlength="4">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>NIC Image Side 1* (ජාතික හැදුනුම්පත පළමු පැති පෙනුම )</label>
                                        <div>
                                            <input type="file" class="form-control" id="id_image" name="id_image" onchange="document.getElementById('nic_image').src = window.URL.createObjectURL(this.files[0])"  accept=".png, .jpg, .jpeg" required>
                                        </div>
                                        <img id="nic_image" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" name="nic_image" alt="NIC image" width="100" height="100" />
                                        <br><label class="text-danger">please select the images less than 2MB</label>
                                    </div>
                                    <div class="form-group">
                                        <label>NIC Image Side 2* (ජාතික හැදුනුම්පත දෙවන පැති පෙනුම)</label>
                                        <div>
                                            <input type="file" class="form-control" id="id_image_two" name="id_image_two" onchange="document.getElementById('nic_image_two').src = window.URL.createObjectURL(this.files[0])" accept=".png, .jpg, .jpeg" required>
                                        </div>
                                        <img id="nic_image_two" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" name="nic_image" alt="NIC image" width="100" height="100" />
                                        <br><label class="text-danger">please select the images less than 2MB</label>
                                    </div>
                                    <div class="form-group">
                                        <label>Degree Certificate (උපාධි සහතිකය)</label>
                                        <div>
                                            <input type="file" class="form-control" id="degree_cert" name="degree_cert" onchange="document.getElementById('degree_certificate').src = window.URL.createObjectURL(this.files[0])" accept=".png, .jpg, .jpeg">
                                        </div>
                                        <img id="degree_certificate" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" alt="Degree certificate" width="100" height="100" />
                                        <br><label class="text-danger">please select the images less than 2MB</label>
                                    </div>
                                    <div class="form-group">
                                        <label>User Image (පරිශීලක ජායාරූපය)</label>
                                        <div>
                                            <input type="file" class="form-control" id="user_img" name="user_img" onchange="document.getElementById('user_image').src = window.URL.createObjectURL(this.files[0])" accept=".png, .jpg, .jpeg">
                                        </div>
                                        <img id="user_image" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" alt="User image" width="100" height="100" />
                                        <br><label class="text-danger">please select the images less than 2MB</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-footer">
                                ...
                                <button id="Update" type="button" class="btn btn-warning d-none pl-5 pr-5">Update</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
...
//                                              console.log(universities);
                                                ...
                                                $("#save").click(function () {
                                                    ...
                                                    if ($('#email').val() != '') {
                                                        if ($('#nic').val() != '') {
                                                            let url_email = "/api/cheack_email";
                                                            ajaxRequest("GET", url_email, data, function (resp) {
                                                                if (resp == 0) {
                                                                    ...
                                                                    let url_nic = "/api/cheack_nic";
                                                                    ajaxRequest("GET", url_nic, data, function (resp) {
                                                                        if (resp == 0) {
