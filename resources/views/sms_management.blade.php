    ...
    <div class="container-fluid">
        <div class="col-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form id="sms_graduate_report_form">
                        <div class="form-row">
                            <div class="col-md-2">
                                <label>District
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-2">
                                <label>Degree
                                    ...
                                    <div id="the-basics">
                                        <input type="text" id="degree" name="degree" class="form-control typeahead" placeholder="BIT" />
                                    </div>
                                </label>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                <label>Year
                                    ...
                                    <input type="text" id="year" name="number" class="form-control" placeholder="graduate year" style="width: 10em">
                                </label>
                            </div>
                            <div class="form-group col-md-2">
                                <label>Person Type
                                    <input type="checkbox" id="graduates_person_type_check" name="graduates_person_type_check" class="ml-2" /></br>
                                    <select class="custom-select" id="graduates_person_type" name="graduates_person_type" class="form-control" style="width: 10em">
                            ...
                            <div class="form-group col-md-2">
                                <label>University
                                    ...
                                    <select id="uni_id" name="uni_id" class="form-control" style="width: 10em">
                                        <option>No data Found</option>
                                    </select>
                                </label>
                            </div>
                        </div>
                        <button id="report_gen" type="button" class="btn btn-primary ml-2 mb-2">Generate</button>
                    </form>
                    <table class="table" id="sms_graduate_report_table">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>First Name</th>
